...
export function LocalCoachApp() {
  ...
  if (student) return <LocalStudentPage data={data} studentId={student.id} update={update} back={() => setSelected(null)} />;
